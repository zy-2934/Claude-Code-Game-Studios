...
<p align="center">
  ...
  <a href=".claude/hooks"><img src="https://img.shields.io/badge/hooks-11-orange" alt="11 Hooks"></a>
...
1. **Clone or use as template**:
   ```bash
   git clone https://github.com/zy-2934/Claude-Code-Game-Studios.git my-game
   cd my-game
   ```
...
Already using an older version of this template? Compare against the upstream
repository history — this fork no longer ships the template upgrade guide.
...
.claude/
  ...
  docs/
    ...
    templates/                      # 40 document templates (37 + 3 collaborative-protocols/)
...
> **Note**: `validate-commit.sh` and `validate-assets.sh` fire on every Bash/Write tool call and exit immediately (exit 0) when the command or file path is not relevant. This is normal hook behavior — not a performance concern.
...
This is a fork of [Donchitos/Claude-Code-Game-Studios](https://github.com/Donchitos/Claude-Code-Game-Studios),
trimmed for use as a project template: the skill-testing framework, session
walkthroughs, and upstream repository meta-files have been removed, and the
workflow has been shortened. File issues and feature requests against this fork,
not upstream — the two have diverged.

---

*Built for Claude Code. Original template by [Donchitos](https://github.com/Donchitos), MIT licensed.*
